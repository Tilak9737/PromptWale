...
import { LayoutDashboard, Image as ImageIcon, Tags, Users, Settings, LogOut } from "lucide-react";
        ...
        <aside className="w-64 bg-card border-r border-border/50 flex flex-col hidden md:flex sticky top-0 h-screen">
            ...
            <div className="p-4 border-t border-border/50">
                <form action={logoutAdmin}>
                    <button type="submit" className="flex items-center space-x-3 px-3 py-2.5 w-full rounded-lg text-red-500 hover:bg-red-500/10 font-medium transition-colors">
                        <LogOut size={18} />
                        <span>Log Out</span>
                    </button>
                </form>
